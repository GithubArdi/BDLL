...
class Restaurant{
    public function tambah(){
        try{
            ...
            $sql = "INSERT INTO tb_resto(nama_restoran, jenis, alamat_resto, jadwal_buka, jadwal_tutup, gambar_resto, deskripsi) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";

            $prep = DB::connection()->prepare($sql);
            $prep->execute([$id_resto, $nama_restoran, $jenis, $alamat_resto, $jadwal_buka, $jadwal_tutup, str_replace('public/', '', $gambar_resto), $deskripsi]);
